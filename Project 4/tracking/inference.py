...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        distanceProb = busters.getObservationProbability(noisyDistance, trueDistance)
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        temp = copy.deepcopy(self.beliefs)
        for i in self.allPositions:
            temp[i] = temp[i] * self.getObservationProb(observation, gameState.getPacmanPosition(),
    ...
    def elapseTime(self, gameState):
        ...
        for pos in self.allPositions:
            ...
            for newPos, prob in newPosDist.items():
                rst[newPos] += self.beliefs[pos] * newPosDist[newPos]
        self.beliefs = util.Counter.copy(rst)
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        # Create a weight distribution over the particles
        ...
        if weightedParticles.total() == 0:
            ...
            for _ in range(self.numParticles):
                newParticle = weightedParticles.sample()
